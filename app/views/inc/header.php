...
<head>
  ...
  <link rel="stylesheet" href="<?php echo URLROOT; ?>vendors/typicons/typicons.css">
  <link rel="stylesheet" href="<?php echo URLROOT; ?>vendors/simple-line-icons/css/simple-line-icons.css">
  <link rel="stylesheet" href="<?php echo URLROOT; ?>vendors/css/vendor.bundle.base.css">
  <!-- Bootstrap 5 -->
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-gH2yIJqKdNHPEq0n4Mqa/HGKIhSkIHeL5AyhkYV8i59U5AR6csBvApHHNl/vI1Bx" crossorigin="anonymous">
  <!-- endinject -->
  <!-- Plugin css for this page -->
  <!--   <link rel="stylesheet" href="<?php echo URLROOT; ?>vendors/datatables.net-bs4/dataTables.bootstrap4.css">
  <link rel="stylesheet" href="<?php echo URLROOT; ?>js/select.dataTables.min.css"> -->
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top">
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text"><?php echo $_SESSION['mensaje'];?><span class="text-black fw-bold"><?php echo $_SESSION['nombre1Usuario'].' '.$_SESSION['nombre2Usuario'].' '.$_SESSION['apellido1Usuario'].' '.$_SESSION['apellido2Usuario'];?></span></h1>
            <h3 class="welcome-sub-text">Los datos de esta semana... </h3>
          </li>
        </ul>
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              ...
              <a class="dropdown-item" href="<?php echo URLROOT;?>"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Cerrar Sesión</a>
            </div>
          </li>
        </ul>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">Filtrar Contenido</span>
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo URLROOT; ?>Libro">
                    <i class="mdi mdi-grid-large menu-icon"></i>
