...
<div class="main-panel">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-sm-flex justify-content-between align-items-start">
                                                        <div>
                                                            ...
                                                            <a class="btn btn-impresion btn-sm" href="<?php echo URLROOT; ?>Cliente/ImprimirListado"><i class="bi bi-printer"></i></a></small>
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div class="table-responsive  mt-1">
                                                        <table class="table select-table" id="tblCliente">
                                                            <thead>
                                                                <tr>
                                                                    <!-- <th>
    ...
    <script src="<?php echo URLROOT ?>js/cliente.js"></script>
